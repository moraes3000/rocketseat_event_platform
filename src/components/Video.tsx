    ...
    <div className='flex-1'>
      ...
      <div className='p-8  w-full max-w-[1100px] mx-auto'>
        <div className='flex itens-start gap-16'>
          <div className='flex-1'>
            <h1 className="text-2xl">Aula 1</h1>
            <p className="mt-4 text-gray-200 leading-relaxed">Aqui vai uma descrição</p>
            ...
            <div className="flex itens-center gap-4 mt-6">
              ...
              <div className='leading-relaxed'>
                <strong className='font-bold text-2xl block'>Bruno</strong>
                <span className='text-gray-200 text-sm block'>Cargo</span>
              </div>
            </div>
          </div>
